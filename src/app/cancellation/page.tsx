      ...
      <section className="relative py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="hero-subtitle mt-8 text-slate-300 max-w-4xl mx-auto text-lg">
            At DriWE, we are committed to providing a reliable and transparent
            platform for both riders and drivers. The following policy outlines
            how ride cancellations are handled within the DriWE app.
          </p>
            ...
            <div className="space-y-12 text-slate-300 text-lg leading-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <p>
                    Once a driver receives a ride request, they have only one
                    choice — to either Accept or Reject the ride.
                  </p>

                  <p>
                    After accepting the ride, the driver cannot cancel it
                    through the app.
                  </p>

                  <p>
                    If, due to any reason, the driver cannot continue with the
                    ride after accepting it, the driver must personally contact
                    the rider and request the rider to cancel it from their end.
                  </p>

                  <p>
                    Drivers repeatedly unable to complete accepted rides may
                    face account review, penalties, or suspension for violating
                    platform rules.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <p>
                    Riders may cancel a ride before the driver reaches the
                    pickup location.
                  </p>

                  <p>
                    Frequent cancellations by a rider may affect their booking
                    reliability and can lead to temporary suspension from DriWE.
                  </p>

                  <p>
                    Once the driver has entered the OTP and the ride has
                    officially started, the rider cannot cancel the ride.
                  </p>

                  <p>
                    If the rider still wishes to end the trip after OTP entry,
                    they must settle the payment directly with the driver.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    DriWE does not handle or process any payments, so there will
                    be no refunds or reversals.
                  </p>

                  <p>
                    Any payment misunderstandings must be mutually resolved
              ...
              <div>
                ...
                <div className="space-y-3">
                  <p>
                    Misuse of the cancellation feature or repeated violations
                    may result in temporary or permanent suspension.
                  </p>

                  <p>
                    DriWE reserves the right to modify, update, or enforce
                    additional actions.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <p>Email: hello@driwe.in</p>
                  <p>Phone: +91 8669888996</p>
                </div>
              </div>
