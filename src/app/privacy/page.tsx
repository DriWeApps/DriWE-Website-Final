        ...
        <div className="container relative z-10 mx-auto flex h-[40vh] items-center justify-center px-4 text-center md:px-6">
          <div className="space-y-4">
            ...
            <p className="text-lg leading-relaxed text-slate-300 max-w-2xl mx-auto">
              ...
              safeguard your data to ensure a safe and transparent experience.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div className="content-card rounded-2xl border border-white bg-black p-6 shadow-lg hover:shadow-yellow-400/40 transition">
                <p className="text-lg leading-relaxed text-slate-300">
                  We value your trust. This Privacy Policy explains how we
              ...
              >
                ...
                <ul className="list-disc pl-6 text-slate-300 space-y-2">
                  ...
                  <li>
                    ...
                    Cookies, device identifiers, analytics tools.
                  </li>
                </ul>
              </section>
              ...
              >
                ...
                <ul className="list-disc pl-6 text-slate-300 space-y-2">
                  <li>
                    ...
                    For payment processing, analytics, and communication.
                  </li>
                  <li>
                    <span className="text-yellow-400 font-semibold">
                      Legal Authorities:
                  ...
                  <li>
                    ...
                    In the case of mergers, acquisitions, or restructuring.
                  </li>
                </ul>
              </section>
              ...
              >
                <h2 className="text-3xl font-bold text-white mb-4">
                  5.<span className="text-yellow-400">Data Security</span>
                </h2>
              ...
              >
                <h2 className="text-3xl font-bold text-white mb-4">
                  6. <span className="text-yellow-400">Cookies & Tracking</span>
                </h2>
                <p className="text-slate-300">
                  We use cookies and similar technologies to enhance your
                  experience, analyze site performance, and deliver targeted
                  advertisements. You may disable cookies in your browser, but
              ...
              >
                ...
                <p className="text-slate-300">
                  ...
                  knowingly collect data from children. If we discover such
              ...
              >
                ...
                <p className="text-slate-300">
                  ...
                  notice. Please review this page periodically.
                </p>
              </section>
            </div>
          </div>
