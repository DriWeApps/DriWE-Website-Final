      ...
      <section className="relative w-full overflow-hidden bg-black py-20">
        ...
        <div className="container relative z-10 mx-auto flex h-[40vh] items-center justify-center px-4 text-center md:px-6">
          <div className="space-y-4">
            ...
            {/* <p className="text-lg leading-relaxed text-slate-300 max-w-2xl mx-auto">
              Welcome to DriWE, a ride-hailing platform operated by DriWE Smartech Pvt. Ltd.
              These Terms and Conditions govern your use of the DriWE App and its services. 
              By downloading, installing, or using the App, you agree to comply with these Terms. 
              ...
              {[
                {
                  ...
                  number: "1",
                  content:
                    "Welcome to DriWE, a ride-hailing platform operated by DriWE Smartech Pvt. Ltd. These Terms and Conditions govern your use of the DriWE App and its services. By downloading, installing, or using the App, you agree to comply with these Terms. If you do not agree to these Terms, you must refrain from using the App.",
                },
                {
                  id: "eligibility",
                  title: "Eligibility",
                  ...
                  content:(
                    <>
                    <p>You must be at least 18 years old to use the App<br></br>
                      You must have a valid mobile device, internet connection, and access to authorized platforms (e.g., Google Play Store) to download the App.<br></br>
                      <b>Drivers must possess:- </b>
                    </p>
                    <ul className="list-disc pl-6 text-slate-300 space-y-2">
                        <li>
                ...
                },
                {
                  ...
                  content: (
                    <>
                      <p className="text-slate-300 mb-3">
                        The App connects riders with drivers for transportation services.
                ...
                },
                {
                  ...
                  content: (
                    <>
                      <p className="text-slate-300 mb-3">
                        Payments for rides are processed through secure payment gateways integrated into the App.<br></br>
                        <b>Fares are calculated based on :</b>
                      </p>
                      <ul className="list-disc pl-6 text-slate-300 space-y-2">
